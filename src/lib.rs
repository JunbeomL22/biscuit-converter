//! # biscuit-converter
//!
//! biscuit-converter is a high-performance integer conversion library using bitwise operations. 
//! It provides safe and efficient ASCII to integer conversion.
//!
//! ## Key Features
//!
//! - **High Performance**: Maintains consistent performance as the number of digits increases, 
//!   showing exceptional speed especially for large numbers.
