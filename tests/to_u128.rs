...
mod tests {
    ...
    fn test_u128_max_check() -> Result<()> {
        ...
        let val_p1 = biscuit.to_u128_decimal(x_p1);
        let val_n1 = biscuit.to_u128_decimal(x_n1);
    ...
    fn test_leading_zero_u128() -> Result<()> {
        ...
        let val_leading_zeros = biscuit.to_u128_decimal(x_leading_zeros).unwrap();
    ...
    fn test_back_and_forth() -> Result<()> {
        ...
        for i in 1..1_000_000 {
            ...
            let val = biscuit.to_u128_decimal(x_bytes).unwrap();
