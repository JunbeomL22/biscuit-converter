...
mod tests {
    ...
    fn test_back_and_forth() -> Result<()> {
        ...
        for i in 1..1_000_000 {
            ...
            let val = biscuit.to_u32_decimal(x_byte).unwrap();
            assert_eq!(
                val, i,
                "Failed for {} bytes", i
            );
    ...
    fn test_to_u32() -> Result<()> {
        ...
        for i in 1..U32_LENGTH_BOUND {
            ...
            let x: &[u8] = &x_vec[..];
            let val = biscuit.to_u32_decimal(x).unwrap();
            assert_eq!(
    ...
    fn test_u32_max() -> Result<()> {
        ...
        let val = biscuit.to_u32_decimal(max_byte);
    ...
    fn test_u32_leading_zeros() -> Result<()> {
        ...
        let val_leading_zeros = biscuit.to_u32_decimal(x_leading_zeros);
